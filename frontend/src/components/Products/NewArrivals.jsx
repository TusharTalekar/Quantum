    ...
    return (
        <section className='py-20 px-4'>
            <div className="max-w-6xl mx-auto text-center mb-16 relative">
                <h2 className="text-3xl font-bold mb-4 text-emerald-800">Explore New Arrivals</h2>
                ...
                <div className="absolute right-0 bottom-[-40px] md:bottom-auto md:top-1/2 md:-translate-y-1/2 flex space-x-4 z-10">
                    <button
                        ...
                        className={`p-3 rounded-full border-2 border-emerald-800 transition-colors ${canScrollLeft
                            ? "bg-emerald-800 text-white hover:bg-emerald-700"
                            : "bg-transparent text-emerald-800 cursor-not-allowed opacity-50"}`}>
                        <FiChevronLeft className="text-2xl" />
                    </button>
                    <button
                        onClick={() => scroll("right")}
                        disabled={!canScrollRight}
                        className={`p-3 rounded-full border-2 border-emerald-800 transition-colors ${canScrollRight
                            ? "bg-emerald-800 text-white hover:bg-emerald-700"
                            : "bg-transparent text-emerald-800 cursor-not-allowed opacity-50"}`}>
                    ...
                    newArrivals.map((product) => (
                        <div
                            ...
                            <img src={product.images[0].url}
                                ...
                                draggable="false"
                            />
                            <div className="absolute bottom-0 left-0 right-0 p-6 bg-stone-800/80 backdrop-blur-md text-white">

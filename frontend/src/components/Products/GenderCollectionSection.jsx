        ...
        <section className="py-24 px-4 bg-amber-50">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
                ...
                <div className="relative group overflow-hidden rounded-xl shadow-lg flex-1">
                    ...
                    />
                    <div className="absolute inset-0 flex items-start p-10 bg-gradient-to-t from-stone-800/70 to-transparent">
                        <div className="text-white mt-auto">
                            <h2 className="text-3xl font-black tracking-wide mb-2">
                                Women's Collection
                            </h2>
                            <Link to="/collections/all?gender=Women"
                                className="text-amber-200 underline text-lg font-bold hover:text-amber-100 transition-colors">
                                Shop Now
                            </Link>
                        </div>
                    </div>

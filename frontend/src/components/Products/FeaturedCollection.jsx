        ...
        <section className='py-24 px-4 bg-lime-100'>
            <div className='max-w-6xl mx-auto flex flex-col-reverse lg:flex-row items-center rounded-xl overflow-hidden'>
                ...
                <div className='lg:w-1/2 p-12 text-center lg:text-left'>
                    <h2 className='text-xl font-medium text-emerald-900 mb-4'>
                        Comfort and Style
                    </h2>
                    <h2 className='text-4xl lg:text-5xl font-bold leading-tight mb-8 text-stone-800'>
                    ...
                    <Link to="collections/all" className="bg-emerald-800 text-white px-10 py-4 font-bold text-lg hover:bg-emerald-700 transition-colors rounded-full">
                        Shop Now
                    </Link>
                </div>
